...
KansasRiverCrossing:{name:"Kansas River Crossing", river:true ,img:"img/landmarks/kansasriver.png"},
BigBlueRiverCrossing:{name:"Big Blue River Crossing", river:true ,img:"img/landmarks/bigblueriver.png"},
FortKearney:{name:"Fort Kearney", river:false ,img:"img/landmarks/fortkearney.png"},
ChimneyRock:{name:"Chimney Rock", river:false ,img:"img/landmarks/chimneyrock.png"},
FortLaramie:{name:"Fort Laramie", river:false ,img:"img/landmarks/fortlaramie.png"},
...
FortBridger:{name: "Fort Bridger", river:false ,img:"img/landmarks/fortbridger.png"},
GreenRiverCrossing:{name: "Green River Crossing", river:true ,img:"img/landmarks/greenriver.png"},
SodaSprings:{name: "Soda Springs", river:false ,img:"img/landmarks/sodasprings.png"},
FortHall:{name: "Fort Hall", river:false ,img:"img/landmarks/forthall.png"},
SnakeRiverCrossing:{name: "Snake River Crossing", river:true ,img:"img/landmarks/snakeriver.png"},
FortBoise:{name:"Fort Boise", river:false ,img:"img/landmarks/fortboise.png"},
//GrandeRonde in the Blue Mountains:{},
BlueMountains:{name: "Blue Mountains", river:false ,img:"img/landmarks/bluemountains.png"},
FortWallaWalla:{name: "Fort Walla Walla", river:false ,img:"img/landmarks/fortwallawalla.png"},
